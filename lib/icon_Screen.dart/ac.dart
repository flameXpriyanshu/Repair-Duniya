...
class MyAc extends StatefulWidget {
  const MyAc({super.key});

  @override
  State<MyAc> createState() => _MyAcState();
}

class _MyAcState extends State<MyAc> {
  @override
  Widget build(BuildContext context) {
    return Icons_widget("screen_assets/ac-service-mistribabu.png",
        "screen_assets/ac1.jpeg", "Air Conditioner");
  }
}

// class MyAc extends StatefulWidget {
//   final List<String> AcList = [
//     "screen_assets/ac_repair.jpg",
//   ];
//   MyAc({super.key});
...
//   // void initState() {
//   //   super.initState();
//   //   _videocontroller = VideoPlayerController.asset('video/Ac_repair.mp4')
//   //     ..initialize().then((_) {
//   //       setState(() {});
...
//   @override
//   Widget build(BuildContext context) {
//     final List<Widget> imgSlider = widget.AcList.map(
//       (item) => Container(
//         height: 400,
//         width: 1000,
//         child: Stack(
...
//                   //   children: widget.AcList.map((url) {
//                   //     int index = widget.AcList.indexOf(url);
//                   //     return Container(
//                   //       width: 8,
//                   //       height: 8,
...
//                                       image:
//                                           ExactAssetImage('assets/booking.png'),
